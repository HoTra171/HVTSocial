    ...
    try {
            ...
            const doInsert = async () => {
                await pgPool.query(`
                  ...
                  `, [
                    ...
                    u.bio, u.date_of_birth, u.gender,
                    u.address,
        ...
        for (const c of sortedComments) {
            ...
            `, [
                ...
                if (err.code === '23503') {
                    console.log(`⚠️ Skipped comment ${c.id}: Parent post/user missing (Likely comment on a shared post).`);
                } else {
        ...
        ON CONFLICT DO NOTHING
      `, [
                f.user_id, f.friend_id, // Wait, MSSQL schema? 
        ...
        for (const s of saved.recordset) {
          ...
          `, [
                ...
                if (err.code === '23503') {
                    console.log(`⚠️ Skipped saved item ${s.id} (Post ID ${s.post_id} not found - likely a shared post).`);
                } else {
